webform.webkey = 'a83ea64c-9c41-4dd4-ab01-bec0e40ee298';
webform.upsells = ["d1bb0ad2-3e92-4d3f-8fd0-af29ccd15757"];
$.extend({
    setLocalData: {
        //initial
        initial: function () {
    ...
    order_update:{
        ...
        setCurrency: function(){
            ...
            myThread = setInterval(function(){
            	var productInfo = $("input[id='Product_22']").data();
...
var webapp = {
    ...
    activeAdapterButton: function(){
        $(".productRadioListItem.Product_56").nextUntil(".step-title").addClass('hidden');
        $('.list-adapters input').change(function(){
            ...
            if(parent.hasClass('active')){
                ...
                webapp.activeProductList(".th",".Product_61","#Product_22");
                return false;
            }
            ...
            if(value == 'adapter1'){
                webapp.activeProductList(".Product_56",".Product_62","#Product_61");
            }
            if(value == 'adapter2'){
                webapp.activeProductList(".Product_57",".Product_48","#Product_62");
            }
            if(value == 'adapter3'){
                webapp.activeProductList(".Product_66",".step-title","#Product_48");
            }
        })
    },
    ...
    fomoImage: function(){
        if($.Fomo){
            $(document).ready(function(){
                if($.Request.QueryString("fomo")=="1"){
                    $.Fomo.image = '/pub-assets/images/product-home.png';
                }
            });
        }else{
            setTimeout(fomo,1000);
        }
    }
}
...
$(document).ready(function() {
    ...
    //detech blank text
    $('input').not(':radio, :checkbox').off('change.changevalue').on('change.changevalue', function() {
